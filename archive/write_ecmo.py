...
prompt = "Evolve a basic timer into an ECMO (Extracorporeal Membrane Oxygenation) Machine Controller. Technical Specs: 1. Centrifugal blood pump flow rate tracking to prevent hemolysis. 2. Membrane oxygenator sweep gas blending (O2/Air). 3. Ultrasonic micro-bubble air-in-line detection and rapid clamping."
...
VAR
    ...
    eState : (INIT, STANDBY, PRIME, RUNNING, EMERGENCY_STOP);
    rO2Fraction : REAL;
    rDeltaP : REAL;
END_VAR
...
CASE eState OF
    ...
    RUNNING:
        ...
        // Let x = O2 fraction of total flow.
        // FiO2 = x(100) + (1-x)(21) => x = (FiO2 - 21) / 79
        ...
        IF fbHemolysisDelay.Q THEN
            ...
            // eState := EMERGENCY_STOP; // Optionally stop, or just alarm to clinician
        END_IF;
