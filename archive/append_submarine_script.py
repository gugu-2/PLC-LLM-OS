...
prompt_text = """You are acting as the Chief Naval Defense Architect for an Advanced Undersea Warfare Division.
...
1. **Phased Acoustic Cavitation Beamforming**:
   ...
   - Dynamic phase shifting to create constructive interference nodes exactly in the path of an incoming supercavitating torpedo ($200\\text{ knots}$).
